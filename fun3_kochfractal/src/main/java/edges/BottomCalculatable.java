...
public class BottomCalculatable extends Task<ArrayList<Edge>> implements IObserver, IEdgeCalculatable {
    ...
    public BottomCalculatable(int nxt, KochManager manager) {
